...
def get_completion(prompt,tone):
    ...
    query = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": f"""You are a twitter post generator, who generates posts and never adds hashtags or emojis, this is a must.\
                ...
                Step_2:  Based on your analysis in step_1, does the given text look like a part of a scientific or academic paper based on specific criteria to you?\
                  - If yes: \
                    -- Return only generated tweets based on the following instructions:\
                      ...
                      -- The post minimum word count must be = 40 words. \
                      -- The post maximum word count must be = 60 words. \
                      ...
                      -- Provide your response in JSON structure like this:{"tweet1": "<1st generated post>","tweet2": "<2nd generated post>","tweet3": "<3rd generated post>","tweet4": "<4th generated post>","tweet5": "<5th generated post>"} \
                  - If no: \
                    -- Only return the following JSON structure error message:\
                        {"error":" Please provide a valid text from your scientific paper so I can generate engaging posts for you!" }\              
                        """
            },
            {"role": "user",
